...
elseif option == 4
    ...
    % wants to graph
    identifier = input('Enter desired identifier. If you do not want to take the identifier into account, enter -1: ');
    ...
    for part=1:R
        if strcmp(identifier, identifiers(part)) || identifier == -1
